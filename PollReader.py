...
class PollReader():
    ...
    def polling_history_change(self):
        ...
        latest_harris = self.data_dict['Harris result'][:n]
        latest_trump = self.data_dict['Trump result'][:n]
        earliest_harris = self.data_dict['Harris result'][-n:]
        earliest_trump = self.data_dict['Trump result'][-n:]
